...
function s.e1tgt(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		local z1=Duel.GetLocationCount(tp,LOCATION_MZONE+LOCATION_EMZONE,PLAYER_NONE,0)
		local z2=Duel.GetLocationCount(1-tp,LOCATION_MZONE+LOCATION_EMZONE,PLAYER_NONE,0)
		return (z1+z2)>1
	end

	local z=Duel.SelectDisableField(tp,2,LOCATION_MZONE+LOCATION_EMZONE,LOCATION_MZONE+LOCATION_EMZONE,0)
