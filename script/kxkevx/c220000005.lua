...
function s.initial_effect(c)
	...
	You can add 1 “Gabriel the Archangel” from your Deck to your hand.
	]]--
	...
	You take no battle damage from that battle, also your opponent gains 3000 LP at the end of the Damage Step.
...
function s.e3evt(e,tp)
	...
	e3b2:SetProperty(EFFECT_FLAG_PLAYER_TARGET+EFFECT_FLAG_CANNOT_DISABLE)
